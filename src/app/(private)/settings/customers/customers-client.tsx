    ...
    <div className="max-w-2xl space-y-3 px-2 py-3 sm:space-y-4 sm:px-4 sm:py-0 md:px-6">
      ...
      {initialContacts.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-[#D8D5C8] py-14 text-center">
          ...
          <p className="font-black text-sm text-[#20231A]">No customers yet</p>
          <p className="mt-1 text-[11px] text-[#5E6654]">Add your first customer to get started</p>
        </div>
      ) : (
        <div className="space-y-2">
          <section className="overflow-hidden rounded-2xl border border-[#D8D5C8] bg-white">
            <div className="flex items-center gap-2 bg-[#F4F1E8] px-4 py-3 sm:px-5">
              ...
              >
                <p className="truncate font-black text-[11px] tracking-wide text-[#34451F] uppercase">
                  Customers <span className="text-[#5E6654]">({initialContacts.length})</span>
                </p>
              </button>
              <button
                type="button"
                  ...
                  >
                    <div className="min-w-0 flex-1 sm:hidden">
                      <div className="flex items-center gap-2">
                        <p className="min-w-0 flex-1 truncate font-black text-xs leading-snug text-[#20231A]">
                          {contact.full_name}
                        </p>
                      </div>
                      <div className="mt-0.5 flex items-center gap-1">
                        <p className="min-w-0 flex-1 truncate text-[10px] font-medium text-[#5E6654]">
                          {contact.email}
                        </p>
                        {contact.birthday && (
                          <span className="shrink-0 font-black text-[10px] text-[#5E6654]">
                    ...
                    <div className="hidden min-w-0 flex-1 sm:block">
                      <p className="truncate font-black text-sm leading-snug text-[#20231A]">
                        {contact.full_name}
                      </p>
                      <p className="mt-0.5 truncate text-[11px] font-medium text-[#5E6654]">
                        {contact.email}
                        {phone && (
                          <span className="ml-2 text-[#5E6654]/60">{phone}</span>
                        )}
                      </p>
                    </div>
                    ...
                    <div className="hidden shrink-0 items-center gap-2 sm:flex">
                      {contact.birthday && (
                        <span className="rounded-lg border border-[#D8D5C8] bg-[#F4F1E8] px-2 py-1 font-black text-[11px] text-[#5E6654]">
                          {formatDate(contact.birthday)}
                        </span>
                      )}
                      {phone && (
                  ...
                  <FormRow label="Phone">
                    <div className="flex flex-1 items-center justify-end gap-2">
                      <input
                        ...
                        className="w-16 bg-transparent text-right font-black text-base text-[#20231A] outline-none placeholder:text-[#5E6654]/40 sm:text-sm"
                      />
