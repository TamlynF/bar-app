...
import { BandBookingCard, BandRequest } from "./components/band-booking-card";
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <div>
          <h2 className="text-xl font-black text-[#1F1F1A] uppercase tracking-tight">Band Applications</h2>
          <p className="text-xs text-[#5F624F] mt-0.5">Review and respond to artist bookings</p>
        </div>
      ...
      {items.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-2xl border border-[#E6DFC8]">
          <Music className="w-10 h-10 text-[#E6DFC8] mx-auto mb-3" />
          <p className="text-[#5F624F] font-bold text-sm">No band applications found</p>
          <p className="text-[#5F624F] text-xs mt-1 opacity-60">Applications will appear here once artists apply</p>
        </div>
      ) : (
