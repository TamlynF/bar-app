      ...
      <div className="mx-auto max-w-7xl space-y-5 px-3 py-3 text-left sm:py-0 md:px-8">
        ...
        {selectedDate ? (
          <div className="animate-in overflow-hidden rounded-2xl border border-[#D8D5C8] bg-white shadow-sm duration-500 fade-in slide-in-from-top-2">
            ...
            <div className="space-y-3 p-4">
              ...
              <div className="hidden items-start justify-evenly gap-4 sm:flex">
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="text-[10px] leading-none font-bold tracking-wide text-[#5E6654]/50 uppercase">Quiz Status</span>
                  <div className={cn(
                    ...
                    quizStatus === "Not Started" && "bg-[#F4F1E8] text-[#5E6654]",
                  )}>
                ...
                <div className="flex flex-wrap gap-2">
                  {tableStatusByCapacity.length === 0 ? (
                    ...
                    tableStatusByCapacity.map((g) => (
                      ...
                      >
                        <span className="text-[9px] font-bold tracking-wide text-[#5E6654] uppercase opacity-60">
                          Cap {g.capacity}
                        </span>
                        <span className="text-base leading-tight font-bold text-[#20231A] tabular-nums">
            ...
            <details className="group border-t border-[#D8D5C8]">
              <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-3 transition-colors select-none hover:bg-[#F4F1E8]">
                <span className="text-[10px] font-bold tracking-wide text-[#5E6654] uppercase">Event Details</span>
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-4xl border-2 border-dashed border-[#D8D5C8] bg-white p-6 text-center shadow-sm">
            ...
            <p className="max-w-50 text-[10px] leading-relaxed font-bold tracking-wide text-[#5E6654] uppercase opacity-60">
