    ...
    >
      ...
      <div className="px-4.5 pt-4 pb-4.5">
        <div className="flex items-center justify-between gap-3">
          <span className="inline-flex items-center gap-2 text-eyebrow font-semibold text-gold">
          ...
          <>
            <div className="mt-3 flex items-end justify-between gap-3">
              <div className="min-w-0">
                <p className="text-eyebrow font-semibold text-ink-2">
        ...
        <Link
          href="/market"
          className={cn(
            "group mt-3 flex h-11 items-center justify-center gap-2 rounded-xl text-btn font-semibold text-on-gold shadow-[0_14px_32px_-12px_rgba(255,107,53,0.6)] transition-transform hover:-translate-y-0.5 active:scale-[0.98]",
